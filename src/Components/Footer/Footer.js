      ...
      <div className="footer__container">
        <div className="footer__start">
          ...
          <h1
            ...
            onClick={() => window.open(`https://spit.ac.in/`, "_blank")}
          >
            By <span className="footer__link">Rishabh Jain & Vedant Jolly</span>
          </h1>
        </div>
        ...
        <div className="footer__center">
          ...
          <h1 className="footer__text footer__text--2">
            Copyright©2021, <span className="react"> ReactJS is
            <FontAwesomeIcon
              icon={faHeart}
